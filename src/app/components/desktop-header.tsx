...
export default function DesktopHeader() {
  ...
  return (
    <div className="sticky top-0 pb-2 bg-white" id="header">
      <div className="h-5 bg-white w-full"></div>
      <header className="bg-white flex w-full align-middle whitespace-normal justify-between overflow-hidden mx-auto container">
        <div>
